...
/* STORPORT: synchronization model (storport.h) */
...
#ifndef SCSI_WMI_REQUEST_BLOCK_DEFINED
#define SCSI_WMI_REQUEST_BLOCK_DEFINED
...
#endif /* SCSI_WMI_REQUEST_BLOCK_DEFINED */
...
(NTAPI *PHW_BUILDIO)(
  IN PVOID DeviceExtension,
  IN struct _SCSI_REQUEST_BLOCK *Srb);
...
typedef struct _HW_INITIALIZATION_DATA {
  ...
  /* STORPORT: optional build-io split; NULL if unused (storport.h) */
